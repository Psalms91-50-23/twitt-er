...
const RoundButton = ({ text, textColor, backgroundColor, buttonStyle, buttonHoverColor, onClickEvent, buttonContainerStyle, icon }) => {
    ...
    >
      <button 
        style={ buttonStyle ? {...buttonStyle, 
          ...
          color: buttonStyle?.color && textColor ? buttonStyle.color 
           : buttonStyle?.color && !textColor ? buttonStyle.color 
           : textColor
           } : { 
